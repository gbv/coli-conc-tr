...
\input{setup.tex}
% FIXME in the following file all necessary input has to be made
\input{input.tex}
...
\noindent\makebox[\linewidth][c]{%
	\colorbox{vzgblue}{%
    	\parbox[l][1.2em][c]{\paperwidth}{%
		    ...
		    \begin{minipage}{.3\textwidth}
        		\includegraphics[width=\linewidth, height=1.7em, keepaspectratio]{figures/vzg.png}
		    \end{minipage}%
  ...
  \begin{center}
%	\colorbox{coligrey}{\includegraphics[scale=0.15]{figures/vzg.png}}
%    \includegraphics[scale=0.5]{figures/vzg-schriftzug.png}\\
...
%	FIXME select used language    
    ...
    {
    \includegraphics[scale=0.3]{figures/coli-conc-wave.png}
    %{\color{vzgblue}\rule[0cm]{\textwidth}{2cm}}\\
    %\colorbox{vzgblue}{\includegraphics[scale=0.7]{figures/coli-conc-wave.png}}
%	  \includegraphics[scale=0.7]{figures/vzg-schriftzug.png}
%		\footnotesize 
%		\selectlanguage{ngerman}
%        Verbundzentrale des GBV (VZG) $\cdot$ Platz der Göttinger Sieben 1 $\cdot$ 37073 Göttingen
    }
  \end{center}
\end{titlepage}
